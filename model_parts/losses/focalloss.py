...
def binary_focal_loss_with_logits(
    ...
    r"""Function that computes Binary Focal losses.
    .. math::
...
def focal_loss(
    ...
    r"""Criterion that computes Focal losses.
    According to :cite:`lin2018focal`, the Focal losses is computed as follows:
    .. math::
        \text{FL}(p_t) = -\alpha_t (1 - p_t)^{\gamma} \, \text{log}(p_t)
    Where:
       - :math:`p_t` is the model's estimated probability for each class.
    ...
    # compute the actual focal losses
